 ...
 * (e.g. 1 lb of flour or 200 g of sugar are simply 1 or 200). Ingredients that are not present in the objects, can 
 * be considered as 0.
 * 
 * Examples:
 * 
...
const cakes = (recipe, ingredients) => {
    return Math.floor(
        Math.min(... Object.entries(recipe)
            .map(entry => ingredients[entry[0]] / entry[1] || 0))
        );
}
